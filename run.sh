...
/mnt/HDD2/yzy23/.conda/envs/ocs/bin/python main.py --dataset citeseer --model basic_gnn
/mnt/HDD2/yzy23/.conda/envs/ocs/bin/python main.py --dataset citeseer --model gcn
/mnt/HDD2/yzy23/.conda/envs/ocs/bin/python main.py --dataset citeseer --model graph_transformer

/mnt/HDD2/yzy23/.conda/envs/ocs/bin/python main.py --dataset pubmed --model basic_gnn
/mnt/HDD2/yzy23/.conda/envs/ocs/bin/python main.py --dataset pubmed --model gcn
/mnt/HDD2/yzy23/.conda/envs/ocs/bin/python main.py --dataset pubmed --model graph_transformer